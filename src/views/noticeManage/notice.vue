  ...
  <section>
    ...
    <div v-if="addMsg==true">
      <div class="messageBox">
        ...
        <el-row :gutter="10" style="margin-bottom:10px;">
          ...
          <p class="textareaBox">
            <el-col :xs="18" :sm="20" :md="21" :lg="22" :xl="22">
              <el-input type="textarea" rows=3 resize=none placeholder="输入发送对象手机号码,可输入多个号码,以逗号隔开" maxlength="140" v-model="input">
              </el-input>
            </el-col>
          </p>
        </el-row>
        <el-row :gutter="10">
          ...
          <p class="textareaBox">
            <el-col :xs="18" :sm="20" :md="21" :lg="22" :xl="22">
              <el-input type="textarea" rows=3 resize=none placeholder="输入消息内容" maxlength="140" v-model="textarea3">
              </el-input>
        ...
        <el-row :gutter="10">
          ...
          <el-col :xs="6" :sm="6" :md="4" :lg="4" :xl="4" style="text-align:right">
            <el-button @click="upload()" type="success" size="small">发送</el-button>
          </el-col>
        </el-row>
      ...
      <div class="noticeHistory" v-if="searchList.length>0">
        ...
        <el-row :gutter="10">
          <el-col :xs="24" :sm="16" :md="16" :lg="16" :xl="16"> <a href="javascript:void(0)" @click="doFilter('all')">全选</a> <a href="javascript:void(0)" @click="doFilter('none')">取消</a>
            <el-button size="small" style="height:26px;" @click="cancelMsg()"> 删除 </el-button>
          </el-col>
          <el-col :xs="24" :sm="8" :md="8" :lg="8" :xl="8" style="text-align:right;">
            <el-col>
              <div class="grid-content bg-purple" style="vertical-align:middle">
                <el-pagination layout="prev, pager, next" :page-size="15" @current-change="search" :total="form.page">
                </el-pagination>
              </div>
            </el-col>
          </el-col>
    ...
    <div v-if="addMsg==false">
      <div class="m-listTitleFoot">
        <el-row>
          <el-col :span="24">
            <div class="grid-content bg-purple">员工列表<span v-if="form.page>0" class="f-fw greyFont"> ({{userTotal}})</span><a href="javascript:void(0)" class="fr" style="line-height:45px" @click="goBack"><img style="width:30px;height:30px;vertical-align:middle" src="../../assets/images/backup.png" alt=""></a></div>
          </el-col>
        </el-row>
      </div>
          ...
          <el-row>
            <el-col :span="12">
              <div class="grid-content bg-purple">
                <el-pagination layout="prev, pager, next" :page-size="20" @current-change="checkSendUser" :total="form.page2">
                </el-pagination>
              </div>
            </el-col>
          </el-row>
