        ...
        <div>
          ...
          <div class="m-details">
            <table class="m-searchTab" style="width:100%;height:100%;">
                    ...
                    <tr v-if="off.tableDetails.indexOf(i)>-1&&v.productType==2">
                      ...
                      <td colspan="11" :rowspan="v.type.length">
                        <table class="m-table2" style="width:100%">
                          <tr  v-for="(v1,i1) in cuteNumberList" :key="i1" style="border-top:1px solid #E6E6E6">
                            <td v-if="cuteNumberList.length>0">
              ...
              <tr v-if="searchList.length>0&&nowStatusHidden!=6&&nowStatusHidden!=5">
                <td colspan="14" style="text-align:left" class="f-pl-10">
          ...
          <div class="m-listTitleFoot" v-if="searchList.length>0">
            <el-row>
              <el-col :span="12">
                <div class="grid-content bg-purple">
                  <el-pagination layout="prev, pager, next" :page-size="15" @current-change="search(currentPage,1)" :current-page.sync="currentPage"
                    :total="form.page">
                  </el-pagination>
                </div>
              </el-col>
      ...
      new Promise((resolve, reject) => {
        ...
        for (let i in vm.searchList) {
          if (vm.searchList[i].ischecked == true) {
            if (
              vm.searchList[i].productState == 6 ||
              vm.searchList[i].productState == 5
            ) {
              //购物车中或已出售
              isInArray = "1";
            } else if (vm.searchList[i].productState == 2 && val == "1") {
              //手动上架
              isInArray = "3";
            } else {
              isInArray = true;
