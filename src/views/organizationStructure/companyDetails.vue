        ...
        <td v-if="change">
          <p style="height:100%;position:relative">
            <el-select style="width:400px;" size="mini" v-model="newDealers" placeholder="请选择修改的渠道">
              <el-option v-for="item in options" :key="item.dealerId" :label="item.dealerIdName" :value="`${item.dealerId},${item.dealerIdName}`">
    ...
    <div class="m-newAddress">
      ...
      <div class="m-dialog-content">
        <el-form :model="addForm" :rules="rules" ref="addForm" label-width="80px">
          ...
          <el-form-item label="联系电话" prop="addPhone">
            <el-input size="small" v-model="addForm.addPhone"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    alter() {
      ...
      vm.addForm.addPhone = lists.phone;
      ...
      vm.select = Object.assign({}, {
        province: lists.soldProvince,
        city: lists.soldCity,
        area: lists.soldCounty
      });
    },
    saveForm(i) {
