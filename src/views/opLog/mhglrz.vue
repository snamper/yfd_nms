      ...
      <div class="dls">
        ...
        <el-row>
             <el-col :span="12"><div class="grid-content bg-purple-light">
                ...
                <el-col :span="18">
                     <el-input v-model="name" size="mini" placeholder="请输入查询的号包名称"></el-input>
                </el-col>
                <el-col :span="2">
         ...
         <el-row class="marginTop">
             <el-col :span="12"><div class="grid-content bg-purple-light">
                ...
                <el-col :span="18">
                     <el-input v-model="phone" size="mini" placeholder="请输入查询的操作人姓名"></el-input>
                </el-col>
                <el-col :span="2">
                </el-col> 
            </div></el-col>
        ...
        <el-row class="marginTop">
            <el-col :span="12"><div class="grid-content bg-purple-light">
                ...
                <el-col :span="18">
                    ...
                    <el-radio v-model="optype"  label="2">手动上架</el-radio>
                    <el-radio v-model="optype"  label="3">手动下架</el-radio>
                    <el-radio v-model="optype"  label="4">自动下架</el-radio>
                </el-col>
                <el-col :span="2">
