            ...
            <el-container>
                <el-header class="headTitleNav">
                    <el-row>
                        ...
                        <el-col :span="5"><div class="grid-content bg-purple-light fr"><a href="javascript:void(0)" class="fcaqua" @click="goBack()">返回列表</a></div></el-col>
                    </el-row>
                </el-header>         
            </el-container>
        </div>
...
import {getDateTime,errorDeal,getStore} from "../../config/utils"
export default{
    props:{forms:Object},
	data (){
		return {
