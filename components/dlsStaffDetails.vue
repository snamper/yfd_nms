        ...
        <div class="yfd">
            <el-container>
                <el-header style="margin-right:1%;margin-left:1%;border-bottom: 1px solid #ccc;padding-top:6px;height:50px;">
                    <el-row>
                        <el-col :span="6"><div class="grid-content bg-purple">公司名称:<span>亚飞达</span></div></el-col>
                        <el-col :span="6"><div class="grid-content bg-purple-light">联系人:<span>aaaa</span></div></el-col>
                        <el-col :span="6"><div class="grid-content bg-purple">手机号码:<span>12345678900</span></div></el-col>
        ...
        <div class="detailsUlDiv">
                ...
                <li>
                    <el-row>
                        ...
                        <el-col :span="20"><div class="grid-content bg-purple-light">
                            <p v-if="off.noModify">{{form.name}}</p>
                            <input v-if="off.modify" type="text" v-model="form.name">
                        </div></el-col>
                    </el-row>
                </li>
                <li>
                    <el-row>
                        ...
                        <el-col :span="20"><div class="grid-content bg-purple-light">
                            <p v-if="off.noModify">{{form.phone}}</p>
                            <input v-if="off.modify" type="text" v-model="form.phone">    
                        </div></el-col>
                    </el-row>
                </li>
                <li>
            ...
            <div class="mt8">
                ...
                <el-row v-if="off.modify" >
                    <el-col style="text-align:center" :span="24"><div class="grid-content bg-purple"><el-button type="danger" @click="checkNo">取消</el-button><el-button type="success" @click="checkYes">确定</el-button></div></el-col>
                </el-row>
            </div>
        </div>
	</div>	 
